...
Revision ID: 12a12f85b368
Revises: a5cffa318ac2
Create Date: 2026-01-30 16:59:53.642992
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('type', sa.Enum('image', 'video', name='mediatypeenum'), nullable=False),
